...
Blockly.Bubble = function(a, b, c, d, e, f, g) {
  ...
  Blockly.RTL && (h = -h);
  this.arrow_radians_ = goog.math.toRadians(h);
  this.workspace_ = a;
  this.content_ = b;
  this.shape_ = c;
...
Blockly.Icon.prototype.createIcon_ = function() {
  this.iconGroup_ || (this.iconGroup_ = Blockly.createSvgElement("g", {}, null), this.block_.getSvgRoot().appendChild(this.iconGroup_), Blockly.bindEvent_(this.iconGroup_, "mouseup", this, this.iconClick_), this.updateEditable())
};
...
Blockly.Connection.prototype.highlight = function() {
  var a;
  this.type == Blockly.INPUT_VALUE || this.type == Blockly.OUTPUT_VALUE ? (a = Blockly.RTL ? -Blockly.BlockSvg.TAB_WIDTH : Blockly.BlockSvg.TAB_WIDTH, a = "m 0,0 v 5 c 0,10 " + -a + ",-8 " + -a + ",7.5 s " + a + ",-2.5 " + a + ",7.5 v 5") : a = Blockly.RTL ? "m 20,0 h -5 " + Blockly.BlockSvg.NOTCH_PATH_RIGHT + " h -5" : "m -20,0 h 5 " + Blockly.BlockSvg.NOTCH_PATH_LEFT + " h 5";
...
Blockly.Tooltip.onMouseMove_ = function(a) {
  if (Blockly.Tooltip.element_ && Blockly.Tooltip.element_.tooltip && 0 == Blockly.dragMode_ && !Blockly.WidgetDiv.isVisible())
    ...
    } else Blockly.Tooltip.poisonedElement_ != Blockly.Tooltip.element_ && (clearTimeout(Blockly.Tooltip.showPid_), Blockly.Tooltip.lastXY_ = Blockly.mouseToSvg(a),
...
Blockly.Trashcan.prototype.createDom = function() {
  ...
  Blockly.createSvgElement("image", {
    ...
    "xlink:href", Blockly.pathToMedia + Blockly.SPRITE.url);
  ...
  this.svgLid_.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", Blockly.pathToMedia + Blockly.SPRITE.url);
  this.animateLid_();
...
Blockly.Trashcan.prototype.animateLid_ = function() {
  ...
  this.svgLid_.setAttribute("transform", "rotate(" + (Blockly.RTL ? -a : a) + ", " + (Blockly.RTL ? 4 : this.WIDTH_ - 4) + ", " + (this.LID_HEIGHT_ - 2) + ")");
  a = goog.math.lerp(.2, .4, this.lidOpen_);
...
Blockly.Xml.blockToDom_ = function(a) {
  ...
  for (c = 0; d = a.inputList[c]; c++) {
    var h;
    f = !0;
    d.type != Blockly.DUMMY_INPUT && (g = d.connection.targetBlock(), d.type == Blockly.INPUT_VALUE ? (h = goog.dom.createDom("value"), e = !0) : d.type == Blockly.NEXT_STATEMENT && (h = goog.dom.createDom("statement")), g && (h.appendChild(Blockly.Xml.blockToDom_(g)), f = !1), h.setAttribute("name", d.name), f || b.appendChild(h))
  }
  e &&
...
Blockly.Xml.domToWorkspace = function(a, b) {
  ...
  for (var d = b.childNodes.length, e = 0; e < d; e++) {
    ...
    if ("block" == f.nodeName.toLowerCase()) {
      ...
      isNaN(h) || isNaN(f) || g.moveBy(Blockly.RTL ? c - h : h, f)
    }
  }
};
...
Blockly.WorkspaceSvg = function(a, b) {
...
Blockly.WorkspaceSvg.prototype.dragMode = !1;
...
Blockly.Mutator.prototype.createEditor_ = function() {
  ...
  var a = this;
  this.workspace_ = new Blockly.WorkspaceSvg(function() {
...
Blockly.Mutator.prototype.updateEditable = function() {
  this.block_.isEditable() ? Blockly.Icon.prototype.updateEditable.call(this) : (this.setVisible(!1), this.iconGroup_ && Blockly.removeClass_(this.iconGroup_, "blocklyIconGroup"))
};
...
Blockly.Mutator.prototype.setVisible = function(a) {
  if (a != this.isVisible())
    if (a) {
      ...
      var c = [];
      a = 0;
      for (var d; d = this.quarkNames_[a]; a++) c[a] = goog.dom.createDom("block", {
        type: d
      });
      this.workspace_.flyout_.show(c);
      this.rootBlock_ = this.block_.decompose(this.workspace_);
      c = this.rootBlock_.getDescendants();
      for (a = 0; d = c[a]; a++) d.render();
...
Blockly.Block.prototype.fill = function(a, b) {
  ...
  if (b) {
    ...
    goog.asserts.assertObject(c, 'Error: "%s" is an unknown language block.',
      b);
    goog.mixin(this, c)
  }
...
Blockly.BlockSvg.prototype.initSvg = function() {
  ...
  this.updateColour();
  Blockly.readOnly || this.eventsInit_ || Blockly.bindEvent_(this.getSvgRoot(), "mousedown", this, this.onMouseDown_);
  goog.isFunction(this.onchange) && !this.eventsInit_ && Blockly.bindEvent_(this.workspace.getCanvas(), "blocklyWorkspaceChange", this, this.onchange);
  this.eventsInit_ = !0;
...
Blockly.BlockSvg.terminateDrag_ = function() {
  ...
  if (2 == Blockly.dragMode_ && a) {
    ...
    a.setDragging_(!1);
    a.render();
    Blockly.gridOptions.snap && a.workspace == Blockly.mainWorkspace && goog.Timer.callOnce(a.snapToGrid_, Blockly.BUMP_DELAY / 2, a);
...
Blockly.BlockSvg.prototype.snapToGrid_ = function() {
  if (this.workspace && 0 == Blockly.dragMode_ && !this.getParent() && !this.isInFlyout) {
    var a = Blockly.gridOptions.spacing,
      b = a / 2,
...
Blockly.BlockSvg.prototype.onMouseUp_ = function(a) {
  ...
  Blockly.doCommand(function() {
    ...
    else if (b.workspace.isDeleteArea(a) && Blockly.selected.isDeletable()) {
...
Blockly.BlockSvg.prototype.onMouseMove_ = function(a) {
  ...
  Blockly.doCommand(function() {
    if (!("mousemove" == a.type && 1 >= a.clientX && 0 == a.clientY && 0 == a.button)) {
      ...
      1 == Blockly.dragMode_ && Math.sqrt(Math.pow(c, 2) + Math.pow(d, 2)) > Blockly.DRAG_RADIUS && (Blockly.dragMode_ = 2, b.setParent(null), b.setDragging_(!0), b.workspace.recordDeleteAreas());
      if (2 == Blockly.dragMode_) {
        var e = b.startDragX + c,
          f = b.startDragY + d;
        b.getSvgRoot().setAttribute("transform",
          "translate(" + e + ", " + f + ")");
...
Blockly.BlockSvg.disposeUiStep_ = function(a) {
  ...
  1 < b ? goog.dom.removeNode(a) : (a.setAttribute("transform", "translate(" + (a.translateX_ + (Blockly.RTL ? -1 : 1) * a.bBox_.width / 2 * b + ", " + (a.translateY_ + a.bBox_.height * b)) + ") scale(" + (1 - b) + ")"), setTimeout(function() {
...
Blockly.BlockSvg.prototype.connectionUiEffect = function() {
  ...
  var a = Blockly.getSvgXY_(this.svgGroup_);
  this.outputConnection ? (a.x += Blockly.RTL ? 3 : -3, a.y += 13) : this.previousConnection && (a.x += Blockly.RTL ? -23 : 23, a.y += 3);
...
Blockly.BlockSvg.prototype.setWarningText = function(a) {
  ...
  if (2 == Blockly.dragMode_) {
    ...
    this.setWarningText.pid_ = setTimeout(function() {
      b.setWarningText.pid_ = 0;
      b.setWarningText(a)
    }, 100)
  } else {
    this.isInFlyout && (a = null);
    var c = !1;
    goog.isString(a) ? (this.warning || (this.warning = new Blockly.Warning(this), c = !0), this.warning.setText(a)) : this.warning && (this.warning.dispose(), c = !0);
    c && this.rendered && (this.render(),
...
Blockly.BlockSvg.prototype.render = function(a) {
  ...
  b += Blockly.RTL ? Blockly.BlockSvg.SEP_SPACE_X : -Blockly.BlockSvg.SEP_SPACE_X;
...
Blockly.BlockSvg.prototype.renderFields_ = function(a, b, c) {
  ...
  for (var d = 0, e; e = a[d]; d++) {
    var f = e.getSvgRoot();
    f && (Blockly.RTL ? (b -= e.renderSep + e.renderWidth, f.setAttribute("transform", "translate(" + b + ", " + c + ")"), e.renderWidth && (b -= Blockly.BlockSvg.SEP_SPACE_X)) : (f.setAttribute("transform", "translate(" + (b + e.renderSep) + ", " + c + ")"), e.renderWidth && (b += e.renderSep + e.renderWidth + Blockly.BlockSvg.SEP_SPACE_X)))
  }
...
Blockly.BlockSvg.prototype.renderCompute_ = function(a) {
  ...
  for (var d = 0, e = 0, f = !1, g = !1, h = !1, k = void 0, l = this.inputsInline && !this.isCollapsed(), q = 0, m; m = b[q]; q++)
    if (m.isVisible()) {
      var p;
      l && k && k != Blockly.NEXT_STATEMENT && m.type != Blockly.NEXT_STATEMENT ? p = c[c.length - 1] : (k = m.type, p = [], p.type = l && m.type != Blockly.NEXT_STATEMENT ?
        Blockly.BlockSvg.INLINE : m.type, p.height = 0, c.push(p));
      p.push(m);
      ...
      q == b.length - 1 && m.renderHeight--;
      p.height = Math.max(p.height, m.renderHeight);
      m.fieldWidth = 0;
      1 ==
        c.length && (m.fieldWidth += Blockly.RTL ? -a : a);
      ...
      p.type != Blockly.BlockSvg.INLINE && (p.type == Blockly.NEXT_STATEMENT ? (g = !0, e = Math.max(e, m.fieldWidth)) : (p.type == Blockly.INPUT_VALUE ? f = !0 : p.type == Blockly.DUMMY_INPUT && (h = !0), d = Math.max(d,
        m.fieldWidth)))
    }
  for (a = 0; p = c[a]; a++)
...
Blockly.BlockSvg.prototype.renderDrawTop_ = function(a, b, c, d) {
  ...
  this.previousConnection && (a.push("H", Blockly.BlockSvg.NOTCH_WIDTH - 15), b.push("H", Blockly.BlockSvg.NOTCH_WIDTH - 15),
    a.push(Blockly.BlockSvg.NOTCH_PATH_LEFT), b.push(Blockly.BlockSvg.NOTCH_PATH_LEFT_HIGHLIGHT), this.previousConnection.moveTo(c.x + (Blockly.RTL ? -Blockly.BlockSvg.NOTCH_WIDTH : Blockly.BlockSvg.NOTCH_WIDTH), c.y));
  a.push("H", d);
  ...
  for (var h, k = 0, l, q, m = 0, p; p = f[m]; m++) {
    ...
    if (this.isCollapsed()) {
      ...
      a.push("H", f.rightEdge), Blockly.RTL ? (b.push("M", h - Blockly.BlockSvg.NOTCH_WIDTH + Blockly.BlockSvg.DISTANCE_45_OUTSIDE + "," + (k + Blockly.BlockSvg.DISTANCE_45_OUTSIDE)), b.push(Blockly.BlockSvg.INNER_TOP_LEFT_CORNER_HIGHLIGHT_RTL), b.push("v", p.height - 2 * Blockly.BlockSvg.CORNER_RADIUS), b.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER_HIGHLIGHT_RTL), b.push("H", f.rightEdge - 1)) : (b.push("M", h - Blockly.BlockSvg.NOTCH_WIDTH + Blockly.BlockSvg.DISTANCE_45_OUTSIDE + "," + (k + p.height - Blockly.BlockSvg.DISTANCE_45_OUTSIDE)),
        b.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER_HIGHLIGHT_LTR), b.push("H", f.rightEdge)), l = e.x + (Blockly.RTL ? -h : h), q = e.y + k + 1, n.connection.moveTo(l, q), n.connection.targetConnection && (n.connection.tighten_(), this.width = Math.max(this.width, f.statementEdge + n.connection.targetBlock().getHeightWidth().width)), m == f.length - 1 || f[m + 1].type == Blockly.NEXT_STATEMENT) && (a.push("v", Blockly.BlockSvg.SEP_SPACE_Y), Blockly.RTL && b.push("v", Blockly.BlockSvg.SEP_SPACE_Y - 1), k += Blockly.BlockSvg.SEP_SPACE_Y);
    k += p.height
  }
  f.length ||
...
Blockly.BlockSvg.prototype.renderDrawBottom_ = function(a, b, c, d) {
  this.height = d + 1;
  this.nextConnection && (a.push("H", Blockly.BlockSvg.NOTCH_WIDTH + " " + Blockly.BlockSvg.NOTCH_PATH_RIGHT), this.nextConnection.moveTo(Blockly.RTL ? c.x - Blockly.BlockSvg.NOTCH_WIDTH : c.x + Blockly.BlockSvg.NOTCH_WIDTH, c.y + d + 1), this.nextConnection.targetConnection && this.nextConnection.tighten_(), this.height += 4);
...
Blockly.BlockSvg.prototype.renderDrawLeft_ = function(a, b, c, d) {
  this.outputConnection ? (this.outputConnection.moveTo(c.x, c.y), a.push("V", Blockly.BlockSvg.TAB_HEIGHT), a.push("c 0,-10 -" + Blockly.BlockSvg.TAB_WIDTH + ",8 -" + Blockly.BlockSvg.TAB_WIDTH + ",-7.5 s " + Blockly.BlockSvg.TAB_WIDTH + ",2.5 " + Blockly.BlockSvg.TAB_WIDTH + ",-7.5"), Blockly.RTL ? (b.push("M", -.3 * Blockly.BlockSvg.TAB_WIDTH + ",8.9"), b.push("l", -.45 * Blockly.BlockSvg.TAB_WIDTH + ",-2.1")) : (b.push("V", Blockly.BlockSvg.TAB_HEIGHT - 1), b.push("m", -.92 * Blockly.BlockSvg.TAB_WIDTH +
    ",-1 q " + -.19 * Blockly.BlockSvg.TAB_WIDTH + ",-5.5 0,-11"), b.push("m", .92 * Blockly.BlockSvg.TAB_WIDTH + ",1 V 1 H 2")), this.width += Blockly.BlockSvg.TAB_WIDTH) : Blockly.RTL || (this.squareTopLeftCorner_ ? b.push("V", 1) : b.push("V", Blockly.BlockSvg.CORNER_RADIUS));
  a.push("z")
};
// Copyright 2013 Google Inc.  Apache License 2.0
Blockly.Msg = {};
...
Blockly.FieldTextInput.prototype.widgetDispose_ = function() {
  ...
  return function() {
    var b = Blockly.FieldTextInput.htmlInput_,
      c = b.value;
    a.sourceBlock_ && a.changeHandler_ && (c = a.changeHandler_(c), null === c && (c = b.defaultValue));
    a.setText(c);
...
Blockly.FieldAngle.prototype.setText = function(a) {
  ...
  this.textElement_ && (this.updateGraph_(), Blockly.RTL ? this.textElement_.insertBefore(this.symbol_, this.textElement_.firstChild) : this.textElement_.appendChild(this.symbol_), this.size_.width = 0)
};
...
Blockly.FieldDropdown.prototype.init = function(a) {
  this.sourceBlock_ || (this.arrow_ = Blockly.createSvgElement("tspan", {}, null), this.arrow_.appendChild(document.createTextNode(Blockly.RTL ? Blockly.FieldDropdown.ARROW_CHAR + " " : " " + Blockly.FieldDropdown.ARROW_CHAR)), Blockly.FieldDropdown.superClass_.init.call(this, a), a = this.text_, this.text_ = null, this.setText(a))
};
...
Blockly.FieldDropdown.prototype.setText = function(a) {
  ...
  null !== a && a !== this.text_ && (this.text_ = a, this.updateTextNode_(), this.textElement_ && (Blockly.RTL ? this.textElement_.insertBefore(this.arrow_, this.textElement_.firstChild) : this.textElement_.appendChild(this.arrow_)), this.sourceBlock_ && this.sourceBlock_.rendered && (this.sourceBlock_.render(), this.sourceBlock_.bumpNeighbours_(), this.sourceBlock_.workspace.fireChangeEvent()))
};
...
Blockly.Variables.allVariablesAndTypes = function(a) {
  var b;
  if (a.getDescendants) b = a.getDescendants(), a = a.workspace;
  else if (a.getAllBlocks) b = a.getAllBlocks();
  else throw "Not Block or Workspace: " + a;
  for (var c = Object.create(null), d = 0; d < b.length; d++) {
    var e = b[d].getVars;
    if (e)
      for (var e = e.call(b[d]), f = 0; f < e.length; f++) {
        var g = e[f];
        g && (c[g.toLowerCase()] = g)
      }
  }
  b = [];
  for (var h in c) d = Blockly.Variables.typeOf(h, a) || Blockly.Variables.TYPE_ANY, b.push([c[h], d]);
  return b
};
Blockly.Variables.changeType = function(a, b, c) {
  c = c.getAllBlocks();
  for (var d = 0; d < c.length; d++) {
    var e = c[d].changeType;
    e && e.call(c[d], a, b)
  }
};
Blockly.Variables.typeOf = function(a, b) {
  for (var c = b.getAllBlocks(), d = 0; d < c.length; d++) {
    var e = c[d].typeOf;
    if (e && (e = e.call(c[d], a))) return e
  }
};
...
Blockly.Variables.flyoutCategory = function(a, b, c, d) {
  ...
  for (var f = void 0, g = 0; g < e.length; g++)
    if (e[g] !== f) {
      ...
      h && "function" === typeof h.postInit && h.postInit.call(h);
      k && "function" === typeof k.postInit && k.postInit.call(k)
    }
};
...
Blockly.Generator.prototype.workspaceToCode = function(a) {
  var b = a || Blockly.mainWorkspace;
  a = [];
  this.init(b);
  for (var b = b.getTopBlocks(!0), c = 0, d; d = b[c]; c++) {
...
Blockly.Toolbox = function(a, b) {
  ...
  this.flyout_ = new Blockly.Flyout;
  a.appendChild(this.flyout_.createDom());
...
Blockly.Toolbox.prototype.init = function(a) {
  this.CONFIG_.cleardotPath = Blockly.pathToMedia + "1x1.gif";
  this.CONFIG_.cssCollapsedFolderIcon = "blocklyTreeIconClosed" + (Blockly.RTL ? "Rtl" : "Ltr");
    ...
    for (var e = 0, f; f = c.childNodes[e]; e++)
      if (f.tagName) {
        ...
        if ("CATEGORY" == g) {
          ...
          h ? g.blocks = h : a(f, g)
        } else "HR" == g ? console.warn("The <hr> separator tag in the toolbox XML needs to be changed to <sep></sep> (due to a bug in IE).") : "SEP" == g ? d.add(new Blockly.Toolbox.TreeSeparator) : "BLOCK" == g && d.blocks.push(f)
      }
  }
  var b = this.tree_;
  b.removeChildren();
  b.blocks = [];
  a(Blockly.languageTree, this.tree_);
...
Blockly.Toolbox.prototype.getRect = function() {
  var a = Blockly.RTL ? Blockly.svgSize().width - this.width : -1E7;
...
Blockly.Css.setCursor = function(a) {
  if (!Blockly.readOnly && Blockly.Css.currentCursor_ != a) {
    ...
    Blockly.svg && (Blockly.svg.style.cursor = a == Blockly.Css.Cursor.OPEN ?
      "" : b)
  }
};
...
Blockly.parseOptions_ = function(a) {
  ...
  if (b) var c = !1,
    ...
    g = !1,
    h = null;
  else h = Blockly.parseToolboxTree_(a.toolbox), c = Boolean(h && h.getElementsByTagName("category").length), d = a.trashcan, void 0 === d && (d = c), e = a.collapse, void 0 === e && (e = c), f = a.comments, void 0 === f && (f = c), g = a.disable, void 0 === g && (g = c);
  var k = a.scrollbars;
  void 0 === k && (k = c);
  var l = a.sounds;
  void 0 === l && (l = !0);
  ...
  a.media ? Blockly.pathToMedia = a.media : a.path && (Blockly.pathToMedia = a.path + "media/");
  ...
  Blockly.gridOptions = m;
  Blockly.enableRealtime = p;
  Blockly.realtimeOptions =
    n
};
Blockly.createDom_ = function(a) {
  ...
  d = Blockly.createSvgElement("pattern", {
    ...
    height: Blockly.gridOptions.spacing
  }, c);
  if (0 < Blockly.gridOptions.length) {
    c = Math.floor(Blockly.gridOptions.spacing /
      2) + .5;
    e = c - Blockly.gridOptions.length / 2;
    var f = c + Blockly.gridOptions.length / 2;
    ...
    1 < Blockly.gridOptions.length && Blockly.createSvgElement("line", {
      x1: c,
      y1: e,
      x2: c,
      y2: f,
    ...
    Blockly.mainWorkspacePattern_ = d
  }
  Blockly.mainWorkspace = new Blockly.WorkspaceSvg(Blockly.getMainWorkspaceMetrics_, Blockly.setMainWorkspaceMetrics_);
  b.appendChild(Blockly.mainWorkspace.createDom("blocklyMainBackground"));
  Blockly.mainWorkspace.maxBlocks = Blockly.maxBlocks;
  Blockly.readOnly || (Blockly.hasCategories ? Blockly.mainWorkspace.toolbox_ = new Blockly.Toolbox(b, a) : Blockly.languageTree && Blockly.mainWorkspace.addFlyout(), Blockly.hasScrollbars || Blockly.addChangeListener(function() {
    if (0 == Blockly.dragMode_) {
      var a = Blockly.mainWorkspace.getMetrics(),
        b = a.viewLeft + a.absoluteLeft,
        c = a.viewTop + a.absoluteTop;
      if (a.contentTop < c || a.contentTop + a.contentHeight > a.viewHeight + c || a.contentLeft < (Blockly.RTL ? a.viewLeft : b) || a.contentLeft +
        a.contentWidth > (Blockly.RTL ? a.viewWidth : a.viewWidth + b))
        for (var d = Blockly.mainWorkspace.getTopBlocks(!1), e = 0, f; f = d[e]; e++) {
          var p = f.getRelativeToSurfaceXY(),
            n = f.getHeightWidth(),
            r = c + 25 - n.height - p.y;
          0 < r && f.moveBy(0, r);
          r = c + a.viewHeight - 25 - p.y;
          0 > r && f.moveBy(0, r);
          r = 25 + b - p.x - (Blockly.RTL ? 0 : n.width);
          0 < r && f.moveBy(r, 0);
          r = b + a.viewWidth - 25 - p.x + (Blockly.RTL ? n.width : 0);
          0 > r && f.moveBy(r, 0)
        }
    }
  }));
...
Blockly.init_ = function() {
  ...
  if (Blockly.languageTree)
    if (Blockly.mainWorkspace.toolbox_) Blockly.mainWorkspace.toolbox_.init(Blockly.mainWorkspace);
    ...
    Blockly.RTL && (Blockly.mainWorkspace.scrollX *=
      -1);
  ...
  if (Blockly.hasSounds) {
    Blockly.loadAudio_([Blockly.pathToMedia + "click.mp3", Blockly.pathToMedia + "click.wav", Blockly.pathToMedia + "click.ogg"],
      "click");
    Blockly.loadAudio_([Blockly.pathToMedia + "delete.mp3", Blockly.pathToMedia + "delete.ogg", Blockly.pathToMedia + "delete.wav"], "delete");
    var b = [],
      a = function() {
...
Blockly.onMouseDown_ = function(a) {
  ...
  Blockly.terminateDrag_();
  Blockly.hideChaff();
  var b = a.target && a.target.nodeName && ("svg" == a.target.nodeName.toLowerCase() || a.target == Blockly.mainWorkspace.svgBackground_);
  !Blockly.readOnly && Blockly.selected && b && Blockly.selected.unselect();
  a.target != Blockly.svg && a.target != Blockly.mainWorkspace.svgBackground_ || !Blockly.isRightButton(a) ? (Blockly.readOnly || b) && Blockly.mainWorkspace.scrollbar && (Blockly.mainWorkspace.dragMode = !0, Blockly.mainWorkspace.startDragMouseX =
    a.clientX, Blockly.mainWorkspace.startDragMouseY = a.clientY, Blockly.mainWorkspace.startDragMetrics = Blockly.mainWorkspace.getMetrics(), Blockly.mainWorkspace.startScrollX = Blockly.mainWorkspace.scrollX, Blockly.mainWorkspace.startScrollY = Blockly.mainWorkspace.scrollY, "mouseup" in Blockly.bindEvent_.TOUCH_MAP && (Blockly.onTouchUpWrapper_ = Blockly.bindEvent_(document, "mouseup", null, Blockly.onMouseUp_)), Blockly.onMouseMoveWrapper_ = Blockly.bindEvent_(document, "mousemove", null, Blockly.onMouseMove_)) : Blockly.showContextMenu_(a)
};
...
Blockly.onKeyDown_ = function(a) {
  if (!Blockly.isTargetInput_(a))
    ...
    a.preventDefault()
  } else if (a.altKey || a.ctrlKey || a.metaKey) Blockly.selected && Blockly.selected.isDeletable() && Blockly.selected.isMovable() && Blockly.selected.workspace == Blockly.mainWorkspace && (Blockly.hideChaff(), 67 == a.keyCode ? Blockly.copy_(Blockly.selected) :
    88 == a.keyCode && (Blockly.copy_(Blockly.selected), Blockly.selected.dispose(!0, !0))), 86 == a.keyCode && Blockly.clipboard_ && Blockly.mainWorkspace.paste(Blockly.clipboard_)
};
...
Blockly.hideChaff = function(a) {
  Blockly.Tooltip.hide();
  Blockly.WidgetDiv.hide();
  !a && Blockly.mainWorkspace.toolbox_ && Blockly.mainWorkspace.toolbox_.flyout_ && Blockly.mainWorkspace.toolbox_.flyout_.autoClose && Blockly.mainWorkspace.toolbox_.clearSelection()
};
Blockly.removeAllRanges = function() {
  if (window.getSelection) {
    var a = window.getSelection();
    a && a.removeAllRanges && (a.removeAllRanges(), setTimeout(function() {
      try {
...
Blockly.isTargetInput_ = function(a) {
  return "textarea" == a.target.type || "text" == a.target.type || "number" == a.target.type || "email" == a.target.type || "password" == a.target.type || "search" == a.target.type || "tel" == a.target.type || "url" == a.target.type
};
...
Blockly.getMainWorkspaceMetrics_ = function() {
  ...
  Blockly.mainWorkspace.toolbox_ && (a.width -= Blockly.mainWorkspace.toolbox_.width);
  ...
  if (Blockly.mainWorkspace.scrollbar) var f = Math.min(d.x - b / 2, d.x + d.width - b),
    ...
    d.x, b = f + d.width, g = d.y, c = g + d.height;
  d = 0;
  !Blockly.RTL && Blockly.mainWorkspace.toolbox_ && (d = Blockly.mainWorkspace.toolbox_.width);
  return {
    viewHeight: a.height,
    viewWidth: a.width,
    contentHeight: c - g,
...
Blockly.setMainWorkspaceMetrics_ = function(a) {
  ...
  a = Blockly.mainWorkspace.scrollX + b.absoluteLeft;
  b = Blockly.mainWorkspace.scrollY + b.absoluteTop;
  Blockly.mainWorkspace.translate(a, b);
  Blockly.mainWorkspacePattern_.setAttribute("x",
    a);
  Blockly.mainWorkspacePattern_.setAttribute("y", b)
};
